...
<div class="edit_project">
	<form action="" method="post" name="project" id="project">
		...
		<div class="section">	
			...
			<div class="right">
				<input type="checkbox" name="project_invoice_method" value="1" class="project_invoice_method checkbox" <?php echo ($results_edit->project_invoice_method == 1) ? 'checked' : '';  ?>>Billable
			</div>
		</div>
		<div class="border_separator"></div>
		<div class="section">	
